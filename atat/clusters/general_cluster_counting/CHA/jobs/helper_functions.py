...
def break_down_cluster_list(str_clusters, structure):
    ...
    str_clusters['mult_vis_range'] = [list(range(int(min(urange))-1, int(max(urange))+1)),list(range(int(min(vrange))-1, int(max(vrange))+1)),list(range(int(min(wrange))-1, int(max(wrange))+1))]
...
def plot_one_bar_chart(counting_types, values, errors=[], ylabel='count/site', label='', color='#D65027'):
    '''
...
def plot_two_bar_charts(filename, counting_types, values1, values2, errors1=[], errors2=[], ylabel='count/site', label1='1', label2='2', color1='#1B62A5', color2='#FD690F'):
    '''
