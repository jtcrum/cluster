...
str_vecs = pickle.load(open('select_str_vecs_7.p','rb'))
str_vecs.append(str_vec)
pickle.dump(str_vecs, open('select_str_vecs_7.p','wb'))

results = pickle.load(open('select_titration_7.p','rb'))
results.append(final_result)
pickle.dump(results, open('select_titration_7.p','wb'))
