...
str_vecs = pickle.load(open('swap_str_vecs_35.p','rb'))
str_vecs.append(str_vec)
pickle.dump(str_vecs, open('swap_str_vecs_35.p','wb'))

results = pickle.load(open('swap_titration_35.p','rb'))
results.append(final_result)
pickle.dump(results, open('swap_titration_35.p','wb'))
