...
str_vecs = pickle.load(open('swap_str_vecs_10_45.p','rb'))
...
#pickle.dump(str_vecs, open('swap_str_vecs_10_45.p','wb'))
pickle.dump(final_result, open('swap_titration_100times_10_45.p','wb'))
